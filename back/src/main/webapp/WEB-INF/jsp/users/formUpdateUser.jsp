...
<form:form method="post" action="" modelAttribute="user">
	...
	<p>
		...
		<form:input path="password" type="password" id="password" value="${user.password}"/>
		<form:errors path="password" />
	</p>
	<p>
		<label for="passwordConfirm">Confirm password*</label>
		<form:input path="passwordConfirm" type="password" id="passwordConfirm" value="${user.password}" />
