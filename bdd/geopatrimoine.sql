...
--
-- Client :  localhost
-- Généré le :  Mar 28 Août 2018 à 12:17
...
(1, 'toto@yahoo.fr', 'pwd', 'Valence', 'user'),
(2, 'tata@gmail.com', 'pwd', 'Villeurbanne', 'user'),
(3, 'titi@yahoo.fr', 'pwd', 'Lyon', 'user'),
...
(62, 'lolo@yahoo.fr', '$2a$10$Dxzq9mgmGfDKMyoFIIiPneh0nejasW3FS/FMY4Ex5uYBg1RaQW4Rq', 'Lyon', 'user'),
(63, 'lulu@yahoo.fr', '$2a$10$b7aGeGMG4mxXoMgADxGKHuWGdLLKExTRtPkQTmo3emprZW/d/K696', 'Valence', 'user'),
(69, 'cb@cb.fr', '$2a$10$Ys48TLlkryWlTFEFQNKjNu2l/7SSN9j5U8FZnO2OskJ8kCaKEpTtm', 'Marseille', 'user'),
(66, 'jean@yahoo.fr', '$2a$10$1y8MM0hm7Nf8ZRxvvBXNdeNl5EKXzk7lKuwO3T1oHI4sGpAGsLLiG', 'Valence', 'user'),
(67, 'momo@gg.fr', '$2a$10$K3Cfpu6QJHOtZUiw4HNXCOKQQVDWgrpITNa7F452pztFaO8yjTY.2', 'Lyon', 'admin'),
(70, 'bn@bn.fr', '$2a$10$vsfqXSEzrsE.iEZTnXSxnOjTCU1UTmOLRutfl3Feo/EPPG17Udtii', 'Marseille', 'user');
