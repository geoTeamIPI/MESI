...
import { Display3dBuildingsComponent } from '../demo/examples/3d-buildings.component';
import { AddImageGeneratedComponent } from '../demo/examples/add-image-generated.component';
import { AddImageComponent } from '../demo/examples/add-image.component';
import { AttributionPositionComponent } from '../demo/examples/attribution-position.component';
import { CenterOnSymbolComponent } from '../demo/examples/center-on-symbol.component';
import { ClusterComponent } from '../demo/examples/cluster.component';
import { CustomMarkerIconsComponent } from '../demo/examples/custom-marker-icons.component';
import { CustomStyleIdComponent } from '../demo/examples/custom-style-id.component';
import { DisplayMapComponent } from '../demo/examples/display-map.component';
import { FullscreenComponent } from '../demo/examples/fullscreen.component';
import { GeoJSONLineComponent } from '../demo/examples/geojson-line.component';
import { HeatMapComponent } from '../demo/examples/heatmap.component';
import { HoverStylesComponent } from '../demo/examples/hover-styles.component';
import { InteractiveFalseComponent } from '../demo/examples/interactive-false.component';
import { LanguageSwitchComponent } from '../demo/examples/language-switch.component';
import { LiveUpdateFeatureComponent } from '../demo/examples/live-update-feature.component';
import { LocateUserComponent } from '../demo/examples/locate-user.component';
import { MapboxGlGeocoderComponent } from '../demo/examples/mapbox-gl-geocoder.component';
import { NavigationComponent } from '../demo/examples/navigation.component';
import { NgxCustomControlComponent } from '../demo/examples/ngx-custom-control.component';
import { NgxCustomMarkerIconsComponent } from '../demo/examples/ngx-custom-marker-icons.component';
import { NgxDragAMarkerComponent } from '../demo/examples/ngx-drag-a-marker.component';
import { NgxDragAPointComponent } from '../demo/examples/ngx-drag-a-point.component';
import { NgxGeoJSONLineComponent } from '../demo/examples/ngx-geojson-line.component';
import { ClusterPopupComponent, NgxMarkerClusterComponent } from '../demo/examples/ngx-marker-cluster.component';
import { NgxScaleControlComponent } from '../demo/examples/ngx-scale-control.component';
import { PopupOnClickComponent } from '../demo/examples/popup-on-click.component';
import { PopupComponent } from '../demo/examples/popup.component';
import { SatelliteMapComponent } from '../demo/examples/satellite-map.component';
import { SetPopupComponent } from '../demo/examples/set-popup.component';
import { SetStyleComponent } from '../demo/examples/set-style.component';
import { ToggleLayersComponent } from '../demo/examples/toggle-layers.component';
